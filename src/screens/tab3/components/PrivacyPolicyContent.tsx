  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.lightText}>
        {`Photo in memory (이하 '회사') 는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.`}
        {'\n'}
      </Text>
...
1. 회원가입 및 관리
회원 가입의사 확인, 회원자격 유지ㆍ관리, 서비스 부정이용 방지 목적으로 개인정보를 처리합니다.
2. 재화 또는 서비스 제공
서비스 제공, 콘텐츠 제공을 목적으로 개인정보를 처리합니다.`}
      ...
      <Text style={styles.lightText}>
        {`① 회사는 법령에 따른 개인정보 보유ㆍ이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유ㆍ이용기간 내에서 개인정보를 처리ㆍ보유합니다.
② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.
- 회원가입 및 관리와 관련한 개인정보는 수집ㆍ이용에 관한 동의일로부터 회원탈퇴 이전까지 위 이용목적을 위하여 보유ㆍ이용됩니다.`}
        {'\n'}
      </Text>
      ...
      <Text
        style={
          styles.boldText
        }>{`제3조 정보주체와 법정대리인의 권리ㆍ의무 및 그 행사방법`}</Text>
      <Text style={styles.lightText}>
        {`① 정보주체는 회사에 대해 언제든지 개인정보 열람ㆍ정정ㆍ삭제ㆍ처리정지 요구 등의 권리를 행사할 수 있습니다.
...
⑥ 회사는 정보주체 권리에 따른 열람의 요구, 정정ㆍ삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.`}
        {'\n'}
      </Text>
...
- 내부관리계획의 수립 및 시행개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다.`}
      ...
      <Text
        style={
          styles.boldText
        }>{`제7조 개인정보 자동 수집 장치의 설치 ㆍ 운영 및 거부에 관한 사항`}</Text>
      <Text style={styles.lightText}>
...
개인정보침해신고센터 : 118 / privacy.kisa.or.kr`}
      ...
      {/* 제10조 */}
      <Text style={styles.lightText}>
        {`본 개인정보처리방침은 2022년 5월 1부터 적용됩니다.`}
        {'\n'}
        {'\n'}
      </Text>
