...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    width: (deviceWidth - margin * 2) / 3,
    height: ((deviceWidth - margin * 2) / 3) * 1.15,
    padding: '7%', // 폴라로이드 크기를 조절하는 상위 padding
    // backgroundColor: '#ccc',
    // borderWidth: 1,
  },
  imageSection: {
  ...
  image: {
    resizeMode: 'contain',
    width: (deviceWidth / 3) * 0.7,
    height: (deviceWidth / 3) * 0.7,
  },
  textBackground: {
    width: '100%',
